...
import { deleteCollection } from "@/app/admin/(panel)/collections/actions";
...
export function CollectionRowActions({ collection }: CollectionRowActionsProps) {
    ...
    },
    {
      ...
      onSelect: () => {
        ...
        const confirmed = window.confirm(
          `Delete "${collection.name}"? Products will stay in your catalog.`,
        );
        if (!confirmed) return;
